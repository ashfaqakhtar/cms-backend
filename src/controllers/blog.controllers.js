...
import { uploadCloudinary } from "../utils/claudinary.js"

const createBlog = async (req, res) => {

    const { title, content, excerpt, thumbnail, author, category, tags, status, date } = req.body

    const requiredFields = ["title", "content", "excerpt", "thumbnail", "category", "status", "author"]
...
const updateBlog = async (req, res) => {
    try {
        const { id } = req.params;
        const { title, content, excerpt, thumbnail, category, tags, status, date } = req.body;
